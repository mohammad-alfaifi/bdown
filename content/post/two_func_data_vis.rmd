...
Now to compare both plots, I need either to go back and forth between both plots or I can use the par function with mfrow parameter, which allows me to display both plots  side by side as it is shown below  
...
By the way, the Sepal.Length is the x-axis for each plot that it below the text plot 'Sepal.Length' and it is the y-axis for each plot that it is on the right of the text plot. 
