...
Let's say that we need the last observation of each month. We may need this kind of data to calculate  the monthly return of S&P500. We can achieve this using the groupby, and .SD in the j command of data table. The .SD returns a subset of x's data of each group. 
