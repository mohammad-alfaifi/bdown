...
The **rbind** function appends the *rows* of  a data frame to another data frame (hence the letter 'r' before 'bind'). However, for this process to work,  both data frames must have the same number of columns and the columns in both data frames must have the same names; otherwise, we will an  error:
